...
// @Router       /api/pilot/v1/task/detect/history [get]
...
// @Router       /api/pilot/v1/docker/deploy [post]
...
// @Router       /api/pilot/v1/docker/deploy [get]
...
// @Param        task_name      query  string false "Task Name"
// @Success      200  {string}  "Success"
// @Router       /api/pilot/v1/docker/deploy [delete]
